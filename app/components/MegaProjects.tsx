...
const projects: Project[] = [
  {
    ...
    highlights: ["Prime Commercial Zone", "Near Metro Station", "RDA Approved"],
    dark: true,
  },
  {
    name: "Lake City Phase 2",
    location: "Lahore",
    roi: "35%+",
  ...
  {
    name: "Bahria Town Safari Villas",
    location: "Islamabad",
    roi: "30%+",
    status: "Pre-Launch",
    statusColor: "bg-blue-500 text-white",
    price: "PKR 3.8 Crore",
    installment: "4-Year Easy Installments",
    highlights: ["International Standard", "Golf Course View", "Smart Home"],
    dark: true,
  },
  {
    name: "Gulberg Green",
    ...
    price: "PKR 2.8 Crore",
    installment: "3-Year Easy Installments",
    highlights: ["4 Kanal Plots", "Private Parks", "24/7 Security"],
    dark: false,
  },
]
